...
// KORRIGIERT: createTransport statt createTransporter
...
class EmailService {
  ...
  // KORRIGIERT: Transporter erst bei Bedarf initialisieren
  getTransporter() {
    if (!this.transporter) {
      ...
      // KORRIGIERT: createTransport (nicht createTransporter)
  ...
  async sendLoginCredentials(email, temporaryPassword) {
    // KORRIGIERT: Credential-Check zur Laufzeit
    ...
    try {
      ...
      // KORRIGIERT: Transporter zur Laufzeit holen
  ...
  // Connection-Test mit Lazy Loading
